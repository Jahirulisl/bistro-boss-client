...
const AllUsers = () => {
  // use axios for only use admin st
  const axiosSecure = UseAxios();
  // use axios for only use admin end
  //from tanstock usequary st
              ...
              users.map((user, index) => <tr key={user._id}>
                ...
                <td>
                  <button onClick={() => handleDeleteUser(user)} className="btn btn-ghost btn-lg">
                    <FaTrashAlt className="text-purple-700 text-2xl"></FaTrashAlt>
                  </button>
                </td>
              </tr>)
            }
